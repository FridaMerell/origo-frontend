      ...
      <div className="relative mx-auto flex w-full max-w-6xl flex-1 flex-col">
        ...
        <section className="flex flex-1 flex-col justify-center py-16">
          ...
          <div className="mt-8 flex w-fit items-center gap-3">
            <button
              onClick={() => retry()}
              className="inline-flex items-center gap-2 rounded-sm bg-[#1B252B] px-5 py-2.5 font-mono text-xs uppercase tracking-[0.12em] text-[#F4F2EC] transition-colors hover:bg-[#58636A]"
            >
              Försök igen
            </button>
            <Link
              href="/"
              className="inline-flex items-center gap-2 rounded-sm border border-[#1B252B] px-5 py-2.5 font-mono text-xs uppercase tracking-[0.12em] text-[#1B252B] no-underline transition-colors hover:bg-[#1B252B] hover:text-[#F4F2EC]"
            >
              Till utgångspunkten ↗
            </Link>
          </div>
