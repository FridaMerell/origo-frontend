...
// Shared Markdown renderer for Flux prose — documents, task and milestone
// descriptions. Supports plain Markdown plus ```mermaid / ```dbschema blocks.
export function Markdown({ content, className = "" }: { content: string; className?: string }) {
  return (
    <div className={`flux-doc max-w-none ${className}`.trim()}>
