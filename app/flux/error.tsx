...
export default function FluxError({
  error,
  retry,
}: {
  ...
  return (
    <section className="relative isolate overflow-hidden rounded-card bg-[#25263B] px-6 py-16 text-center text-[#FFF9F0] shadow-lg sm:px-10 sm:py-24">
      ...
      <div className="relative z-10 mx-auto flex max-w-md flex-col items-center">
        <span className="font-mono text-6xl font-bold tracking-tight text-[#EFA052] sm:text-7xl">!</span>
        ...
        <div className="mt-8 flex items-center gap-3">
          <button
            onClick={() => retry()}
            className="inline-flex items-center gap-1.5 rounded-md border border-[#FFF9F0]/35 bg-white/5 px-4 py-2 text-sm font-medium text-[#FFF9F0] transition-colors hover:border-[#EFA052] hover:bg-[#EFA052] hover:text-[#25263B]"
          >
            <RefreshCwIcon size={15} /> Försök igen
          </button>
          <Link
            href="/"
            className="inline-flex items-center gap-1.5 rounded-md border border-[#FFF9F0]/35 bg-white/5 px-4 py-2 text-sm font-medium text-[#FFF9F0] no-underline transition-colors hover:border-[#EFA052] hover:bg-[#EFA052] hover:text-[#25263B]"
          >
