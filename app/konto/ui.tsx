...
export const HEADING = `text-[14px] font-mono uppercase tracking-[0.16em] text-[#58636A]`;
...
export function Section({ title, image, children }: { title: string; image?: ReactNode; children: ReactNode }) {
  return (
