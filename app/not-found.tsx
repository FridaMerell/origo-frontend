  ...
  return (
    <main className="relative flex min-h-screen flex-col overflow-hidden bg-[#E7E5DE] px-5 py-6 text-[#1B252B] sm:px-10 sm:py-10">
      ...
      <div className="relative mx-auto flex w-full max-w-6xl flex-1 flex-col">
        <span className="font-[family-name:var(--font-geist-mono)] text-[11px] font-medium uppercase tracking-[0.18em]">
          ORIGO / 00°00′
        </span>
        <section className="flex flex-1 flex-col justify-center py-16">
          <span className="mb-5 flex size-12 items-center justify-center rounded-full border border-[#1B252B] font-[family-name:var(--font-geist-mono)] text-xs">
            404
          </span>
          ...
          <Link
            href="/"
            className="mt-8 inline-flex w-fit items-center gap-2 rounded-sm bg-[#1B252B] px-5 py-2.5 font-[family-name:var(--font-geist-mono)] text-xs uppercase tracking-[0.12em] text-[#F4F2EC] no-underline transition-colors hover:bg-[#58636A]"
          >
            Till utgångspunkten ↗
          </Link>
        </section>
