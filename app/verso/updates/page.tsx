  ...
  return (
    <div className="flex flex-1 flex-col gap-5 p-7">
      <div className="flex items-baseline justify-between">
        ...
        <Drawer trigger="Lägg till uppdatering" title="Ny uppdatering">
          <UpdateForm />
        </Drawer>
      </div>
            ...
            columns={[
              {
                key: "entry",
                render: (e) => (
                  <Link href={`/updates/${e.id}`} className="flex w-full items-center gap-3 no-underline">
                    ...
                    <span className="shrink-0 text-xs text-text-faint">
                      {new Date(e.created_at).toLocaleString("sv-SE", { month: "short", day: "2-digit" })}
                    </span>
                  </Link>
                ),
              },
